...
| **[Automation with Terraform](https://www.notion.so/brimah/Homework-Assignment-6-1335e543df1e80f6a946dd47a94e05b4)** | `aws-infrastructure-automation` | **Standardized VPC Blueprints:** Engineered reusable Terraform modules for multi-AZ VPCs, implementing consistent subnet math, NAT Gateway placement, and route table logic. |
...
| **[ECS NGINX](https://github.com/Brimah-Khalil-Kamara/Project-Containerized-Web-Orchestration)** | `containerized-web-orchestration` | **Container Networking:** Implemented Fargate networking modes and task-level Security Groups for public-facing containerized service isolation. |
| **[Jenkins on EC2](https://github.com/Brimah-Khalil-Kamara/Project-Automated-Jenkins-Controller)** | `automated-jenkins-controller` | **Inbound Traffic Control:** Hardened the CI/CD controller using CIDR-restricted Security Groups (Port 8080/22) and SSH-key authenticated tunneling for secure remote management.|
| **[Jenkins on Docker](https://github.com/Brimah-Khalil-Kamara/Project-Jenkins-2)** | `containerized-jenkins-environment` | **Container Network Isolation:** Implemented Docker bridge networking to isolate the Jenkins container from the host, utilizing port mapping and volume persistence for secure, ephemeral build environments. |
...
|Deploying a Simple Express API backend server on AWS EC2   | <a href="https://github.com/Brimah-Khalil-Kamara/Project-Simple-Express-API">Simple-Express-API</a>|
